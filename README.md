...
For the third milestone, you can find our website [here](https://go.epfl.ch/tarantino). Please keep in mind that this project has been designed for chromium based browser. The code can be seen on the [site](https://github.com/com-480-data-visualization/project-2023-vatadiz2/site) branch of the repository.
